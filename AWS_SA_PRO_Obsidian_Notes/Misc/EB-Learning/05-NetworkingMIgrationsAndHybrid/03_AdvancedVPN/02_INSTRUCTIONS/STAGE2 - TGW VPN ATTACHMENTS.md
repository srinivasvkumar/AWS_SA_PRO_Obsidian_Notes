...
In STAGE2 of the DEMO lesson you will be creating two [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] attachments for the [[Transit gateway]]
This has the effect of creating two [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] connections ... 1 for each of the customer gateways
...
Once the connections have been created, you will download the configuration files which will be required to configure the onpremises [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] endpoints (customer gateways)
...
There is a document in this folder called `DemoValueTemplate.md` - it contains [[AWS_SA_PRO_Obsidian_Notes/Master/InfrastructureAsCode (CloudFormation)/02-portable-template/instructions|instructions]] on how to extract all of the configuration variables you will need
You will extract these from three locations

- [[cloudformation|Outputs]] of the ONPREM CFN Stack
- For Connection1, `CONNECTION1CONFIG.TXT`
- For Connection2, `CONNECTION2CONFIG.TXT`

Go ahead and populate that template using the [[AWS_SA_PRO_Obsidian_Notes/Master/InfrastructureAsCode (CloudFormation)/02-portable-template/instructions|instructions]] in the template
