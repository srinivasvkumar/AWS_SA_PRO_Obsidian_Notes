...
Make sure before starting this stage that both [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] connections are in an `available` state
...
You can also check the connection in the AWS [[AWS_SA_PRO_Obsidian_Notes/Master/VPC|VPC]] Console ...the tunnels should be down, but IPSEC should be shown as UP after a few minutes.
...
There is now network connectivity between the ONPREM and AWS environments, but as these are Dynamic [[AWS_SA_PRO_Obsidian_Notes/Master/BGP|BGP]] Connections .. 
.. the next stage will add [[AWS_SA_PRO_Obsidian_Notes/Master/BGP|BGP]] capability to activate the connections.
