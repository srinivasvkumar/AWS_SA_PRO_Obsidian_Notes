...
Wait for both [[cloudformation|stacks]] to move into a `CREATE_COMPLETE` status **Estimated time to complete 5-10 mins**

# STAGE 1B - CREATE CUSTOMER GATEWAY OBJECTS 

Open a new tab to the [[AWS_SA_PRO_Obsidian_Notes/Master/VPC|VPC]] Console
Open a new tab to [[cloudformation]] Console
In the [[cloudformation]] Tab
Click ON-PREM stack
Click [[cloudformation|Outputs]]
Note down IP for `Router1Public` and `Router2Public`

In the [[AWS_SA_PRO_Obsidian_Notes/Master/VPC|VPC]] Console https://console.aws.amazon.com/vpc/home?region=us-east-1#
Select `Customer Gateways` under `Virtual private Network (VPN)`
Click `Create Customer gateway`
Set Name to `ONPREM-ROUTER1`
Click `Dynamic` for routing
Set [[AWS_SA_PRO_Obsidian_Notes/Master/BGP|BGP]] ASN to `65016`
...
# STAGE 2A - CREATE [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] ATTACHMENTS FOR [[Transit gateway]]
...
Populate the [[DemoValueTemplate]], [[AWS_SA_PRO_Obsidian_Notes/Master/InfrastructureAsCode (CloudFormation)/02-portable-template/instructions|instructions]] are in that template.


# STAGE 3A - CONFIGURE IPSEC TUNNELS FOR ONPREMISES-ROUTER1

BEFORE DOING THIS STAGE
BOTH [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] CONNECTIONS
...
This is is the file which configures the IPSEC Tunnel interfaces over which our [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] traffic flows.
...
This file controls [[api-gateway|authentication]] for the tunnels
Replace the following placeholders with the real values in the `DemoValueTemplate.md` document
...
# STAGE 4A - CONFIGURE [[AWS_SA_PRO_Obsidian_Notes/Master/BGP|BGP]] ROUTING FOR ONPREMISES-ROUTER1 AND TEST
...
# STAGE 4B - CONFIGURE [[AWS_SA_PRO_Obsidian_Notes/Master/BGP|BGP]] ROUTING FOR ONPREMISES-ROUTER2 AND TEST
...
- Delete the [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] COnnections
