...
- The initial AWS environment with 2 subnets, 2 [[ec2]] instances, a TGW and [[AWS_SA_PRO_Obsidian_Notes/Master/VPC|VPC]] attachment and a default route pointing at the TGW
- The simulated on-premises environment - 1 public subnet, 2 private subnets. The public subnet has 2 Ubuntu + strongSwan + Free [[AWS_SA_PRO_Obsidian_Notes/Master/VPN|VPN]] endpoints.
...
Open a new tab to the [[AWS_SA_PRO_Obsidian_Notes/Master/VPC|VPC]] Console (https://console.aws.amazon.com/vpc/home?region=us-east-1#)
