...
- LB architecture:
![LB Architecture](AWS_SA_PRO_Obsidian_Notes/Master/05-compute/images/ELBArchitecture1.png)
...
![CROSS-ZONE LB Architecture](AWS_SA_PRO_Obsidian_Notes/Master/05-compute/images/ELBArchitecture2.png)
...
- **Application Load Balancer ([[ALB]])**:
    ...
    - [[ALB]] offer [[route53|health checks]] evaluation at application layer
    - Application Load Balancer Rules:
        ...
        - Rule [[cloudformation|conditions]]: host-header, http-header, http-request-method, path-pattern, query-string and source-ip
...
- **Network Load Balancer ([[NLB]])**:
    ...
    - [[route53|Health checks]] can only check ICMP or TCP handshake
    ...
    - NLBs can be used for [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/privatelink|privatelink]] <-- <span style="color: #ff5733;">EXAM</span>
...
- **Scenarios for [[NLB]]**:
    ...
    - [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/privatelink|privatelink]]
