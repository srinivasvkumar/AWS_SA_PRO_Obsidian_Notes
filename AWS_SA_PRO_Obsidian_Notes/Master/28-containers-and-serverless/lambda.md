...
- [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]] are stateless, meaning there is no data left over after an invocation
...
- The [[appsync|security]] for a Lambda function is controlled by the execution role. This is an [[iam]] role attached to the function. This can have permissions for integration with [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|other AWS services]]

## Lambda Networking

- [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]] can have 2 types of networking modes:
    - Public (default):
        ...
        - With public networking mode Lambda function wont be able to access resources in a [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] unless the resources do have public IPs and [[appsync|security]] controls allow external access
    - [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] Networking:
        - [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]] will run inside a [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]], so they will access everything in a [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]], assuming NACLs and SGs allow access
        - They wont be able to access services outside of the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]], unless networking configuration exists in the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] to allow external access
        - The Lambda needs `EC2Networking` permissions in order ot be able to create ENIs in the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]]
        - [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] based [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]] do not directly in the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]], they will use a shared ENI to access resources in the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] as long as all the functions have the same [[appsync|Security]] Group. In case new [[appsync|Security]] Groups are attached to a certain Lambda, new ENIs are placed inside the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]]
        - At the creation of the function, a certain ENI might be created for accessing the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]]. The initial setup would take up to 90 seconds. This setup will take place only once, not at every invocation

## Lambda Security

- There are 2 key parts of the [[appsync|security]] model
    - [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda Functions]] will assume an execution role in order to access other AWS resources
    - Resource [[policies]]: similar to resource [[policies]] for [[AWS_SA_PRO_Obsidian_Notes/Master/04-storage/s3|s3]]. Allows external accounts to invoke a [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]], or certain services to use [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]]. Resources polices can be modified using the CLI/API (currently cannot be changed with the console)
...
- There are 3 ways [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]] can be invoked:
    - **Synchronous invocation**:
        - Command line or API directly invoking the function
        - The CLI or API will wait until the function returns
        - [[api-gateway|API Gateway]] will also invoke Lambdas synchronously, use case for many serverless applications
        - Any [[api-gateway|errors]] or retries have to be handled on the client side
    - **Asynchronous invocation**:
        - Used typically when AWS services invoke the function (example: [[AWS_SA_PRO_Obsidian_Notes/Master/04-storage/s3|s3]] events)
...
- Key and value pairs for associated with [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]]
...
- Used to split off libraries and dependencies from [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]]
- Reduces the size of the deployment package
- Layers can be reused by multiple [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]]
...
- Many [[organizations]] use containers and [[cicd|CI/CD]] processes built for containers
...
- [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Lambda functions]] can be registered to [[ALB]] target groups
