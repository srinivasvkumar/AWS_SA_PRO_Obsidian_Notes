...
- **General Purpose SSD (GP2/GP3)**:
    ...
    - IO Credit:
        ...
        - 1 IO credit = 1 IOPS
    - If we have no [[Master/Git_hub_notes/certified-aws-solutions-architect-professional-main/README|credits]] for the volume, we can not perform any IO
    - The IO bucket has 5.4 million of [[Master/Git_hub_notes/certified-aws-solutions-architect-professional-main/README|credits]], it refills based at rate based on the baseline performance of the storage
    - The baseline performance for GP2 is based on the volume size, we get 3 IO [[Master/Git_hub_notes/certified-aws-solutions-architect-professional-main/README|credits]] per second, per GB of volume size. Also, it fills with a min of 100 IO credit per second regardless of the volume size
    - By default GP2 can burst up to 3000 IOPS
    - If we consume more [[Master/Git_hub_notes/certified-aws-solutions-architect-professional-main/README|credits]] than the bucket is refilling, than we are depleting the bucket
    ...
    - Max IO 16000 IO [[Master/Git_hub_notes/certified-aws-solutions-architect-professional-main/README|credits]] per second, any volume larger than 5.33 TB will achieve this maximum rate constantly
...
- **Provisioned IOPS SSD (IO1/2)**:
    ...
    - Per instance performance: maximum performance between [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|EBS]] service and [[ec2]]. Usually this implies more than one volume in order to be saturated. Max values:
...
- HDD based volume types:
    ...
    - **SC1**:
        ...
        - Volume size can be between 125 GB and 16 TB
        - It is the lower cost [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|EBS]] storage available

## Instance Store Volumes

- Provides block storage devices, raw volumes which can be mounted to a system
- They are similar to [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|EBS]], but they are local drives instead of being presented over the network
...
- [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Instance stores]] are included in the price of [[ec2]] instances with which they come with
- **[[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Instance stores]] have to be attached at launch time, they can not be added afterwards!**
...
- One of the primary benefit of [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|instance stores]] is performance, ex: D3 instance provides 4.6 GB/s throughput, I3 volumes provide 16 GB/s of sequential throughput with NVMe SSD
- Instance store considerations:
    - Instance store volumes are local to [[ec2]] hosts
    - Instance store can be added only at launch
    - Data is lost on an [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|instance stores]] in case the instance is moved, resized or there is a hardware failure
    - [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Instance stores]] provide high performance
    - For instance store volumes we pay for it with the [[ec2]] instance
    - Instance store volumes are temporary!

## Choosing between Instance Store and EBS

- Fer persistence storage we should default to [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|EBS]]
- For resilience storage we should avoid instance store an default to [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|EBS]]
- If the storage should be isolated from [[ec2]] instance lifecycle we should use [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|EBS]]
...
- RAID0 + [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|EBS]]: up to 260000 IOPS (maximum possible IOPS per [[ec2]] instance)
