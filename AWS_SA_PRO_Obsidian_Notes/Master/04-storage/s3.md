...
- **[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Standards (default)**:
    ...
    - When objects are stored in [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] using the API, a HTTP 200 OK response is provided
    - [[billing]]: 
        - GB/month of data stored in [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]
    ...
    - [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard makes data accessible immediately, can be used for static website hosting
    - Should be used for data frequently accessed
- **[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Standard-IA**:
    - Shares most of the characteristics of [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard: objects are replicated in 3 AZs, durability is the same, availability is the same, first byte latency is the same, objects can be made publicly available
    - [[billing]]:
        - It is more cost effective for storing data
        - Data transfer fee is the same as [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard
...
- **[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] One Zone-IA**:
    - Similar to [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard, but cheaper. Also cheaper than [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard IA
    - Data stored using this class is only stored in one region
    - [[billing]]:
        - Similar to [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard IA: similar minimum duration fee of 30 days, similar [[billing]] for smaller objects and also similar retrieval fee per GB
...
- **[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Instant Retrieval**:
    - It like [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Standard-IA, but with cheaper storage, more expensive retrieval, longer minimums
...
- **[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Flexible Retrieval (formerly knowns as [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]])**:
    - Same data replication as [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard and [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard IA
    - Same durability characteristics
    - Storage cost is about 1/6 of [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] standard
    - [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] objects stored in [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] should be considered cold objects (should not be accessed frequently)
    - Objects in [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] class are just pointers to real objects and they can not be made public
    - In order to retrieve them, we have to perform a retrieval process:
        ...
        - When objects are retrieved for [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]], they are temporarily stored in standard IA and they are removed after a while. We can retrieve them permanently as well
    - Retrieval job types:
    ...
    - [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] has a 40KB minimum billable size and a 90 days minimum duration for storage
    - [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] should be used for data archival (yearly access), where data can be retrieved in minutes to hours
- **[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Deep Archive**:
    ...
    - Objects can not be made publicly available, data access is similar to standard [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] class
    - Restore jobs are longer:
        - **Standard**: up to 12 hours
        - **Bulk**: up to 48 hours
    - Should be used for archival which is very rarely accessed
- **[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Intelligent-Tiering**:
    ...
    - [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Intelligent-Tiering is recommended for unknown or uncertain data access usage
- Storage classes comparison:

|                                    | [[Srinivas_Notes/S3|S3]] Standard            |  [[Srinivas_Notes/S3|S3]] Intelligent-Tiering | [[Srinivas_Notes/S3|S3]] Standard-IA         | [[Srinivas_Notes/S3|S3]] One Zone-IA          | [[Srinivas_Notes/S3|S3]] [[Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Instant       | [[Srinivas_Notes/S3|S3]] [[Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Flexible     | [[Srinivas_Notes/S3|S3]] [[Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Deep Archive |
|------------------------------------|------------------------|-------------------------|------------------------|-------------------------|--------------------------|-------------------------|-------------------------|
...
- We can create lifecycle rules on [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] buckets which can move objects between tiers or expire objects automatically
...
- Transitions between tiers:
    ![Transition between tiers](AWS_SA_PRO_Obsidian_Notes/Master/04-storage/images/S3StorageClassesLifecycleConfiguration.png)
- Considerations:
    - Files from One Zone-IA can transition to [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Flexible, or Deep Archive, NOT into [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Instant retrieval
    ...
    - A single rule can not move objects instantly from standard IA to infrequent tiers and then to [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] tiers. Objects have to stay for at least 30 days in infrequent tiers before being able to be moved by one rule only. In order ot overcome this, we can define 2 different rules

## S3 Replication

- 2 types of replication are supported by [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]:
...
- Replication consideration:
    ...
    - Replication is capable of handling objects encrypted with SSE-[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] and SSE-[[kms]] (with extra configuration). SSE-C (customer managed keys) is also supported, historically it was incompatible
    ...
    - Any objects in the [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] and [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Deep Archive will not be replicated
...
- Server-side encryption is mandatory, we cannot store data in [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] without being encrypted
- There are 3 types of server-side encryption supported:
    - **SSE-C**: server-side encryption with customer-provided keys
        - Customer is responsible for managing the keys, [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] managed encryption/decryption
        - When an object is put into [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]], we need to provide the key utilized
    ...
    - **SSE-[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]** (default): server-side encryption with Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]-managed keys
        - AWS handles both the encryption/decryption and the key management
        - When using this method, [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] creates a master key for the encryption process (handled entirely by [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]])
        ...
        - For most situations, this is the default type of encryption. It uses AES-256 algorithm, they key management is entirely handled bt [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]
    - **SSE-[[kms]]**: Server-side encryption with customer-managed keys stored in AWS Key Management Service ([[kms]])
        - Similar to SSE-[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]], but for this method the [[kms]] handles stored keys
        - When an object is uploaded for the first time, [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] will communicate with [[kms]] and creates a customer master key (CMK). This is default master key used in the future
...
- Default Bucket Encryption:
    ...
    - Values for the header:
        - To use SSE-[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]: `AES256`
        - To use SSE-[[kms]]: `aws:[[kms]]`
    - All Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] buckets have encryption configured by default, and all new objects that are uploaded to an [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] bucket are automatically encrypted at rest
    - Server-side encryption with Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] managed keys (SSE-[[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]) is the default encryption configuration for every bucket in Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]], this can be overridden in a PUT request with `x-amz-server-side-encryption` header
...
- Bucket keys:
    - A time limited bucket key is used to generate DEKs within [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]
    - [[kms]] generates a bucket key and gives it to [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] to use to generate DEKs for each upload, offloading the load from [[kms]] to [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]
...
- Thing to keep in mind after enabling bucket keys:
    ...
    - Fewer [[cloudtrail]] events of [[kms]] will be in the logs (since work is offloaded to [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]])
...
- The user will interact with [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] using the presigned URL as if it was the person who generated the presigned URL
...
- [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] can store huge objects (up to 5 TB)
- Retrieving a huge objects will take time and consume transfer capacity
- [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]/Glacier provides services to access partial objects using SQL-like statements to select parts of objects
- Both [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Select and [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] selects supports the following formats: CSV, JSON, Parquet, BZIP2 compression for CSV and JSON
...
- Access Points simplify the process of managing access to [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] buckets/objects
...
- The Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Block Public Access feature provides settings for access points, buckets, and accounts to help manage public access to Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] resources
- The settings we can configure with the Block Public Access Feature are:
    ...
    - **BlockPublicPolicy**: This prevents a bucket policy containing public actions from being created or modified on an [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] bucket, the bucket itself will still allow the existing policy
...
- [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Select and [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Glacier]] Select: save in network a CPU cost by retrieving ony the necessary data
- [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Lifecycle Rules: transition objects between tiers
- Compress objects to save space
- [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Requester Pays:
    - In general, bucket owners pay for all Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] storage and data transfer costs associated with their bucket
...
- Object Lock can be enabled on newly created [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] buckets. For existing ones in order to enable Object Lock we have to contact AWS support
...
- There are 2 ways [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] managed object retention:
    - Retention Period
    - Legal Hold
...
- There are 2 types of retention period modes:
    ...
    - **Governance mode**:
        ...
        - This identities should have the `[[Srinivas_Notes/S3|S3]]:BypassGovernanceRetention` permission
...
- An extra permission is required when we want to add or remove the Legal Hold on an object: `[[Srinivas_Notes/S3|S3]]:PutObjectLegalHold`
- Legal Hold can be used for preventing accidental removals

## S3 Transfer Accelerate

- Used to transfer files into [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]. Enables fast, easy, and secure transfers of files over long distances between our client and an [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] bucket
...
- We might want to use Transfer Acceleration on a bucket for various reasons:
    ...
    - We can't use all of our available bandwidth over the internet when uploading to Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]
...
- With Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Object [[lambda]], we can add our own code to Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] `GET`, `LIST`, and `HEAD` requests to modify and process data as it is returned to an application
- [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Object [[lambda]] uses AWS [[lambda]] functions to automatically process the output of standard [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] `GET`, `LIST`, or `HEAD` requests
- After we configure a [[lambda]] function, we attach it to an [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] Object [[lambda]] service endpoint, known as an *Object [[lambda]] Access Point*
- The Object [[lambda]] Access Point uses a standard [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] access point
- When we send a request to your Object [[lambda]] Access Point, Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] automatically calls your [[lambda]] function

## Hosting Static Site on S3

- We can host a static site on [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]
...
- Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]] website endpoints do not support HTTPS! If we want to use HTTPS, we can use Amazon [[cloudfront]] to serve a static website hosted on Amazon [[AWS_SA_PRO_Obsidian_Notes/Master/S3|S3]]
