...
- We can configure which devices we want to use for testing (huge selection is available). We can configure device state, additional apps, radio [[step-functions|states]], locations, etc.