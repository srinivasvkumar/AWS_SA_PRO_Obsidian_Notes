...
- For most documents the [[AWS_SA_PRO_Obsidian_Notes/Master/Machine_Learning/Textract|Textract]] is capable to operate in a synchronous way (real time)
...
- Use cases of [[AWS_SA_PRO_Obsidian_Notes/Master/Machine_Learning/Textract|Textract]]:
...
- It can be integrated with [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|other AWS services]]