...
- We input a document and [[AWS_SA_PRO_Obsidian_Notes/Master/Machine_Learning/Comprehend|Comprehend]] will develop insights by recognizing the entities, key phrases, language, sentiments and other common elements of the document
- How the system works:
    - Input = Document
    - Output = Entities, phrases, language, PII, sentiments
- [[AWS_SA_PRO_Obsidian_Notes/Master/Machine_Learning/Comprehend|Comprehend]] is ML services and it is based on pre-trained and custom models
