...
- Integration with other services:
    ![AWS Batch Integration](AWS_SA_PRO_Obsidian_Notes/Master/08-data-analytics/images/AWSBatch2.png)

## AWS Batch vs Lambda

- [[lambda]] has a 15 minutes execution limit, for longer workflows we should use Batch
- [[lambda]] has limited disk space in the environment, we can fix this by using [[efs]], but this would require the function to be run inside of a [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]]
...
- Managed:
    ...
    - We decide the instance type/size and if we want to use on-demand or [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|spot instances]]
    - We can determine our own max spot price
    - We need to create [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] gateways for access to the resources
