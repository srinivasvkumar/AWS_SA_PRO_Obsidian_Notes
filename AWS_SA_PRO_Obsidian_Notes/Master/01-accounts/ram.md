...
- It is a [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] which provides infrastructure which can be used by other services
- In AWS this has been traditionally architected using separate networks connected using [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] peering or Transit Gateways. With AWS RAM and AWS [[organizations]] we can create something which is more effective:
    ![Shared Services VPC](RAM.png)
- [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] owner can create and manage the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] and subnets which are shared with participants of the same [[AWS Organization]]
...
- Resources created by a participant account will not be visible for other participants or by the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] owner account
