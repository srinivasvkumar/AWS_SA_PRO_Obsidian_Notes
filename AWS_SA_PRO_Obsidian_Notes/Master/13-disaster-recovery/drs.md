...
- We can increase IT resilience when you use [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|AWS Elastic Disaster Recovery]] to replicate on-premises or cloud-based applications running on supported operating systems
...
- [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|AWS Elastic Disaster Recovery]] automatically converts our servers to boot and run natively on AWS when we launch instances for drills or recovery
