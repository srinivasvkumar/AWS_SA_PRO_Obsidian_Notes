...
- [[cloudfront]] moves the content closer to the customer by [[api-gateway|caching]] it on the Edge Location. Global Accelerator moves the customer closer to the service pe providing access to the AWS global network
