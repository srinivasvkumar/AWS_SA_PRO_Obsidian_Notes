...
- DNS is a discovery service, [[AWS_SA_PRO_Obsidian_Notes/Master/16-other/translate|translate]] information which machines need into information that humans need and vice-versa
...
- A hosted zone can be public, accessible for the public internet, part of the public DNS system, or it can be private, linked to one or more [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]](s)
...
- [[AWS_SA_PRO_Obsidian_Notes/Master/12-security-and-config/cloudhsm|Limitations]]: does not support health checks!
...
- The private key [[kms|signing]] key used to sign those DNS key records and create the RRSIG and DNSKEY records
- At this point [[kms|signing]] is configured (step 1)
...
- In every [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]].2 IP address is reserved for the DNS
- In every subnet the .2 is reserved for Route53 resolver
- Via this address [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] resources can access [[R53]] Public and associated private hosted zones
- Route53 resolver is only accessible from the [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]], hybrid network integration is problematic both inbound and outbound
![Isolated DNS Environments](AWS_SA_PRO_Obsidian_Notes/Master/03-networking/images/Route53Endpoints1.png)
- Solution to the problem before Route53 endpoints were introduced:
![Before Route53 Endpoints](AWS_SA_PRO_Obsidian_Notes/Master/03-networking/images/Route53Endpoints2.png)
- Route53 endpoints:
    - Are deliver as [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]] interfaces (ENIs) which can be accessed over [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpn|vpn]] or DX
...
![Route53 Endpoints Architecture](AWS_SA_PRO_Obsidian_Notes/Master/03-networking/images/Route53Endpoints3.png)
