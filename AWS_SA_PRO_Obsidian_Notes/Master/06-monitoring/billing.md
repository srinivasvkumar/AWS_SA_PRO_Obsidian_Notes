...
- We can view data for up to last 12 months, [[AWS_SA_PRO_Obsidian_Notes/Master/16-other/forecast|forecast]] how much we are likely to spend for the next tree months and get recommendations on what [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Reserved Instances]] to purchase
...
- The AWS Cost and Usage report is a `.csv` file or a collection of `.csv` files that is stored in an [[AWS_SA_PRO_Obsidian_Notes/Master/04-storage/s3|s3]] bucket. Anyone who has permissions to access the specified [[AWS_SA_PRO_Obsidian_Notes/Master/04-storage/s3|s3]] bucket can see the billing report files
...
- With [[Budgets]], we can view the following information:
    ...
    - Our usage to date, including how much you have used of your [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|Reserved Instances]] and purchased Savings Plans
