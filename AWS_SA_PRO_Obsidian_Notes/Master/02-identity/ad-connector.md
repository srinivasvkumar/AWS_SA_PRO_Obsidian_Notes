...
- AD Connector provides a pair of directory endpoints in a [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]]
- It injects ENIs into to subnets in a [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpc|vpc]]
...
- Requires a working network to on-premise service, otherwise wont work (private network via Direct Connect or [[AWS_SA_PRO_Obsidian_Notes/Master/03-networking/vpn|vpn]])

## AD Connector Architecture

![AD Connector](AWS_SA_PRO_Obsidian_Notes/Master/02-identity/images/DirectoryServiceADConnector.png)
