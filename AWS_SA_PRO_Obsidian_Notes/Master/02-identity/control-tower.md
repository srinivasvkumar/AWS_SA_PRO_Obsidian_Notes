...
- Control Tower orchestrates [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|other AWS services]] to provide this functionality
...
- **Landing Zones**: it is the multi-account environment
    - Provides via [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|other AWS services]]:
        - SSO/ID Federation
        - Centralized [[vpc-flow-logs|logging]] and auditing
...
- When Control Tower is set up, it creates to OUs:
    - Foundational OU ([[appsync|security]])
    - Custom OU (sandbox)
...
- A Landing Zone creates the [[appsync|Security]] and Sandbox OUs, we can create other OUs and accounts as well
...
- We can allow end-users to provision new accounts from a Landing Zone using [[service-catalog|Service Catalog]]
...
- Guardrails function in two different ways:
    ...
    - [[AWS_SA_PRO_Obsidian_Notes/Master/12-security-and-config/detective|detective]]: compliance check
