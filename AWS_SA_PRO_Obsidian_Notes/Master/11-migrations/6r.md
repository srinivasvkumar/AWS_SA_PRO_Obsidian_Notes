...
- We might use [[AWS_SA_PRO_Obsidian_Notes/Master/04-storage/s3|s3]] as a backup or media storage
...
- Requires a full [[nonportable_instructions|review]] of the architecture of an application
...
![Migration Plan](AWS_SA_PRO_Obsidian_Notes/Master/11-migrations/images/6RsOfMigration.png)
