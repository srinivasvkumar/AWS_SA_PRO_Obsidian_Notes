...
- It is:
    ...
    - Deployments integrated with [[cicd|CI/CD]]:
        - AWS Proton automatically provisions the resources, configures the [[cicd|CI/CD]] pipeline, and deploys the code into the defined infrastructure