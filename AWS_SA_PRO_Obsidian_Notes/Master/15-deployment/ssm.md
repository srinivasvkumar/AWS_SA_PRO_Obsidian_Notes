...
- Output of commands can be sent to [[AWS_SA_PRO_Obsidian_Notes/Master/04-storage/s3|s3]] or we can send [[sns]] notifications
...
- Patch Baselines:
    - For Linux: `AWS-[OS]DefaultPatchBaseline` - explicitly defines patches, example: `AWS-AmazonLinux2DefaultPatchBaseline`, `AWS-UbuntuDefaultPatchBaseline` - contain [[appsync|security]] updates and any critical update
