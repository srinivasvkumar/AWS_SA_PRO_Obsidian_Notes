...
- Key [[policies]] and [[appsync|security]]:
    - Key [[policies]] (Resource): they are different compared to [[policies]] [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|other AWS services]] have in the way that each KMS keys policy has to explicitly allow access from the owner AWS account
