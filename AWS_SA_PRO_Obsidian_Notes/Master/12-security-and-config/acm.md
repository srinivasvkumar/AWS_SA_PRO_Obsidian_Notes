...
---
[[acm.png]] [[acm 2.png]] [[acm 1.png]]
# AWS Certificate Manager - ACM

- HTTPS (SSL/TSL) was designed to address [[appsync|security]] problems occurred with HTTP
...
- Not all services all supported. Services which integrate with ACM are the following: load balancers, [[cloudfront]], [[cognito]], Elastic Beanstalk, [[Master/Git_hub_notes/AWS-SAP-C02-Notes-main/README|App Runner]], [[api-gateway|API Gateway]], AWS Nitro Enclaves, [[opensearch]], [[network-and-dns-firewall|AWS Network Firewall]]. [[ec2]], for example, is not supported <span style="color: red;">EXAM</span>
