...
- Layer 5 firewalls:
    ...
    - With this it reduces admin overhead, with the addition of being able to implement more contextual [[appsync|security]]
...
- Web Access Control List (WEBACL) are used by WAF to protect services and we associate them with [[ALB]], [[api-gateway|API Gateway]], [[cloudfront]] or with [[appsync]]
...
- Web Access Control Lists (WEBACL):
    ...
    - [[AWS_SA_PRO_Obsidian_Notes/Master/05-compute/others|AWS Outposts]] do not support WEBACLs
- Rule groups:
    - Groups of rules
...
- Rules:
    ...
    - We can also have more than one statement with AND, OR, NOT [[cloudformation|conditions]]
    - Action: 
...
- Pricing:
    ...
    - Optional [[appsync|security]] features can be enabled for additional costs:
